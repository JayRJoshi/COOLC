...
#define SW    "\tsw\t"
#define LW    "\tlw\t"
#define LI    "\tli\t"		//load immidiate (rd, imm)
#define LA    "\tla\t"

#define MOVE  "\tmove\t"
#define NEG   "\tneg\t"		//negate value with overflow ( rd, rs)
#define ADD   "\tadd\t"		//addition with overflow (rd, rs, rt)
#define ADDI  "\taddi\t"	//addition immidiate overflow (rd, rs, imm)
#define ADDU  "\taddu\t"	//addition without overflow	(rd, rs, rt)
#define ADDIU "\taddiu\t"	//addition immidiate w/o overflow (rd, rs, imm)
#define DIV   "\tdiv\t"		//div with overflow (rd, rs1, rs2)
#define MUL   "\tmul\t"		//mul "
#define SUB   "\tsub\t"		//sub (rd, rs, rt)
#define SLL   "\tsll\t"		//shift left logical
#define BEQZ  "\tbeqz\t"	// rs, label
#define BRANCH   "\tb\t"	//branch label
#define BEQ      "\tbeq\t"
#define BNE      "\tbne\t"
#define BLEQ     "\tble\t"
#define BLT      "\tblt\t"
